...
export function AchievementModalContent({ title, description, imageSrc, certificateLink }: AchievementModalContentProps) {
  return (
    <div className="flex flex-col gap-4 p-4 max-w-lg text-[var(--fontcolor-white)]">
      ...
      <a
        className="px-5 py-2 mt-4 bg-[var(--gray-600)] rounded-lg shadow-md hover:bg-[var(--gray-300)] transition-colors duration-100 cursor-pointer min-w-60 m-auto text-center"
