...
export function ProjectModalContent({ imagesProject, title, description, stacksProject, imageSrc, deployLink, repositoryLink }: ProjectModalProps) {
  return (
    <div className="flex flex-col gap-4 max-w-4xl">
      ...
      <div className="flex gap-3 p-1">
        <SwiperContent contents={imagesProject} quantityDisplayContent={1} projectContent />
