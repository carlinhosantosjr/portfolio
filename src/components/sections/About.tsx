export function About() {
  return (
    <div className="flex flex-col w-[652px] bg-[var(--gray-400)] gap-3">
      ...
      <div className="flex flex-col space-y-3 bg-[var(--gray-500)] m-3 text-[var(--fontcolor-mediumgray)] transition-all duration-200 hover:text-[var(--fontcolor-lightgray)] p-2 text-[1rem]">
        <p>
