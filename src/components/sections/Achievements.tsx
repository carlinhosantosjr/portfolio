...
export function Achievements({ openModal }:AchievementsProps) {
  ...
  return (
    <div id="achievementsSection" className="flex flex-col w-full screen650:w-[652px] bg-[var(--gray-400)] gap-3 mt-10">
      ...
      <div className="flex space-y-3 bg-[var(--gray-500)] m-3 text-[var(--fontcolor-mediumgray)] p-2 text-[1rem] text-center">
        <div className="flex flex-wrap screen550:flex-1 screen550:p-4 p-2 gap-2 justify-between">
