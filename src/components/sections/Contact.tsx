...
export function Contact() {
  return (
    <div id="contactSection" className="flex flex-col w-full screen650:w-[652px] bg-[var(--gray-400)] gap-3 mt-10">
      ...
      <div className="flex flex-col space-y-3 bg-[var(--gray-500)] m-3 text-[var(--fontcolor-white)] p-2 text-[1rem] gap-4">
        ...
        <a href="https://wa.me/5516991051414" target="_blank" rel="noopener noreferrer">
          <div className="flex flex-col screen550:flex-row items-center transition-all duration-200 hover:cursor-pointer hover:shadow-sm hover:scale-[1.02] hover:bg-[var(--gray-600)] rounded-lg p-2">
        ...
        <a href="https://www.linkedin.com/in/carlinhosantosjr" target="_blank" rel="noopener noreferrer">
          <div className="flex flex-col screen550:flex-row w-full items-center transition-all duration-200 hover:cursor-pointer hover:shadow-sm hover:scale-[1.02] hover:bg-[var(--gray-600)] rounded-lg p-2">
            <img className="h-15 pr-2 rounded-bl-lg " src={linkedinIcon} alt="" />
            <span>Linkedin:</span>
            <span className=" text-[var(--fontcolor-lightgray)] ml-1.5 w-full overflow-hidden text-ellipsis truncate text-center screen550:text-left">https://www.linkedin.com/in/carlinhosantosjr
            </span>
          </div>
        </a>
