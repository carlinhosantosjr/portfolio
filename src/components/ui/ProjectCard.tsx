...
export function ProjectCard({ imagePreviewSrc, title, description, stacksProject }: ProjectCardProps) {
  return (
    <div className="flex gap-3 bg-[var(--gray-500)] p-4 transition-all duration-200 hover:cursor-pointer hover:shadow-sm hover:scale-[1.06] hover:bg-[var(--gray-600)] ">
